<form id="" class="form" method="POST" action="{{ route('the_model.update',$theModel->id) }}" enctype="multipart/form-data">
    ...
    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        <div class="fv-row mb-7">
            ...
            <input type="text" id='name'  name="name" value="{{$theModel->name}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Please Enter the Model Name here." required />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">Model Image</label>
            <input type="file" accept=".jpg,.png" id='model_image' name="model_image" class="form-control form-control-solid mb-3 mb-lg-0"  />
        </div>
        <div class="fv-row mb-7">
            <label class="required fw-bold fs-6 mb-2">3D Model</label>
            <input type="file" accept=".glb" id='3d_model'  name="3d_model" class="form-control form-control-solid mb-3 mb-lg-0"  />
